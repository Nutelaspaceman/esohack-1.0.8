...
import com.esoterik.client.util.RenderBuilder;
...
implements Util {
    ...
    public static void drawSelectionBox(AxisAlignedBB axisAlignedBB, double height, Color color) {
        ...
        RenderUtil.addChainedFilledBoxVertices(bufferbuilder, axisAlignedBB.field_72340_a, axisAlignedBB.field_72338_b, axisAlignedBB.field_72339_c, axisAlignedBB.field_72336_d, axisAlignedBB.field_72337_e + height, axisAlignedBB.field_72334_f, color);
        tessellator.func_78381_a();
    }

    public static void drawSelectionBoundingBox(AxisAlignedBB axisAlignedBB, double height, Color color) {
        bufferbuilder.func_181668_a(3, DefaultVertexFormats.field_181706_f);
        RenderUtil.addChainedBoundingBoxVertices(bufferbuilder, axisAlignedBB.field_72340_a, axisAlignedBB.field_72338_b, axisAlignedBB.field_72339_c, axisAlignedBB.field_72336_d, axisAlignedBB.field_72337_e + height, axisAlignedBB.field_72334_f, color);
        tessellator.func_78381_a();
    }
    ...
    public static void drawBoxBlockPos(BlockPos blockPos, double height, Color color, RenderBuilder.RenderMode renderMode) {
        ...
        switch (renderMode) {
            case Fill: {
                RenderUtil.drawSelectionBox(axisAlignedBB, height, color);
                break;
            }
            case Outline: {
                RenderUtil.drawSelectionBoundingBox(axisAlignedBB, height, color);
                break;
            }
            case Both: {
                RenderUtil.drawSelectionBox(axisAlignedBB, height, color);
                RenderUtil.drawSelectionBoundingBox(axisAlignedBB, height, new Color(color.getRed(), color.getGreen(), color.getBlue(), 144));
                break;
            }
            case Glow: {
    ...
    public static void drawText(BlockPos pos, String text) {
        ...
        GlStateManager.func_179097_i();
        GlStateManager.func_179137_b((double)(-((double)esohack.textManager.getStringWidth(text) / 2.0)), (double)0.0, (double)0.0);
