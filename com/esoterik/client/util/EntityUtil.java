...
implements Util {
    ...
    public static boolean isCrystalAtFeet(EntityEnderCrystal crystal, double range) {
        for (EntityPlayer player : EntityUtil.mc.field_71441_e.field_73010_i) {
            if (EntityUtil.mc.field_71439_g.func_70068_e((Entity)player) > range * range || esohack.friendManager.isFriend(player)) continue;
    ...
    public static float calculate(double x, double y, double z, EntityLivingBase base) {
        ...
        double densityDistance = distance = (1.0 - distance) * (double)EntityUtil.mc.field_71441_e.func_72842_a(new Vec3d(x, y, z), base.func_174813_aQ());
    ...
    public static void swingArmNoPacket(EnumHand hand, EntityLivingBase entity) {
        ...
        if (!entity.field_82175_bq || entity.field_110158_av >= EntityUtil.getArmSwingAnimationEnd(entity) / 2 || entity.field_110158_av < 0) {
    ...
    public static boolean isntValid(Entity entity, double range) {
        return entity == null || EntityUtil.isDead(entity) || entity.equals((Object)EntityUtil.mc.field_71439_g) || entity instanceof EntityPlayer && esohack.friendManager.isFriend(entity.func_70005_c_()) || EntityUtil.mc.field_71439_g.func_70068_e(entity) > MathUtil.square(range);
    }
